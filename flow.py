...
def generate_flow(gamera_directory,
                  output_directory,
                  start_time,
                  psf_model_path,
    ...
    #         date_obs=datetime(int(year), int(month), int(day), int(hour), int(minute), int(second)),
...
if __name__ == "__main__":
    # generate_flow.serve("/Users/jhughes/Desktop/data/gamera_mosaic_jan2024",) # TODO: figure out serving

    generate_flow("/Users/jhughes/Desktop/data/gamera_mosaic_jan2024",
                  "/Users/jhughes/Desktop/d0/",
                  datetime.now(),
